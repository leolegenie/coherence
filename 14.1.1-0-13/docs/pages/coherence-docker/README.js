...
<td class="">Coherence Metrics, exposed on port <code>9612</code></td>
</tr>
<tr>
...
<div class="section">
<p>Assuming that you have first cloned the Coherence CE project the to build the Coherence image run the following command
...
<p>So, if the version in the <code>pom.xml</code> is <code>14.1.1-0-13</code> the image produced will be
<code>oraclecoherence/coherence-ce:14.1.1-0-13</code></p>
...
<p>The example above would build an image named <code>foo/coherence:14.1.1-0-13</code></p>
...
<div class="section">
<p>Many options in Coherence can be set from System properties prefiexed with <code>coherence.</code>.
...
<p>Once the Coherence container is running perform some interations with it using one of the exposed services, i.e Extend
