...
<h4 id="executors-overview">Overview</h4>
<div class="section">
...
<h4 id="executors-usage">Usage Examples</h4>
<div class="section">
...
<p>If no executor has been configured with the given name, the <code>RemoteExecutor</code> will throw <code>RejectedExecutionException</code>.</p>

<p>Each <code>RemoteExecutor</code> instance may hold local resources that should be released when the <code>RemoteExecutor</code> is no longer needed.  Like an <code>ExecutorService</code>, a <code>RemoteExecutor</code> has similar methods to shut the executor down.  When calling these methods, it will have no impact on the executors registered within the cluster.</p>

</div>

<h4 id="executors-configuration">Configuration</h4>
<div class="section">
...
<h5 id="_configuration_elements">Configuration Elements</h5>
<div class="section">
...
<p>Note that the <code>AtomicInteger</code> and <code>AtomicLong</code> types used above <em>are not</em> types from the <code>java.util.concurrent.atomic</code> package they you are familiar with&#8201;&#8212;&#8201;they are actually interfaces defined within <code>com.oracle.coherence.concurrent.atomic</code> package, that both <code>LocalAtomicXyz</code> and <code>RemoteAtomicXyz</code> classes implement, which are the instances that are actually returned by the methods above.</p>
