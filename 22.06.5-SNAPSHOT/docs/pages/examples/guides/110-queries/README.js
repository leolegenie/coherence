...
<ul class="ulist">
<li>
<p><a id="" title="" target="_blank" href="https://coherence.community/22.06.5-SNAPSHOT/api/java/com/tangosol/util/Filter.html">Filter</a></p>

</li>
<li>
<p><a id="" title="" target="_blank" href="https://coherence.community/22.06.5-SNAPSHOT/api/java/com/tangosol/util/ValueExtractor.html">ValueExtractor</a></p>

</li>
<li>
<p><a id="" title="" target="_blank" href="https://coherence.community/22.06.5-SNAPSHOT/api/java/com/tangosol/util/aggregator/package-summary.html">Aggregator</a></p>
...
<li data-value="2">We create a Filter that will select only countries with more than 60 million people using a <code>GreaterEqualsFilter</code></li>
...
void testValueExtractor() {
    ...
    ReducerAggregator&lt;String, Country, String, String&gt; aggregator
            = new ReducerAggregator&lt;&gt;("getName"); <span class="conum" data-value="3" />
...
<ul class="colist">
<li data-value="1">Get the <code>countries</code> Map</li>
<li data-value="2">We create the same <code>GreaterEqualsFilter</code> as in the previous test (Select countries with more than 60 million people, only)</li>
...
<li data-value="1">Get the <code>countries</code> Map</li>
<li data-value="2">We create the same <code>GreaterEqualsFilter</code> as in the previous test (Select countries with more than 60 million people, only)</li>
<li data-value="3">We will use a different <code>Aggregator</code>. <code>BigDecimalSum</code> will aggregate the population and return a <code>Bigecimal</code> value</li>
<li data-value="4">Apply the <code>Filter</code> and <code>Aggregator</code></li>
...
<a id="" title="" target="_blank" href="https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.2206/develop-applications/querying-data-cache.html#GUID-A6A97011-A2FB-45A4-B9FC-AA0C8C49C057">Querying Data In a Cache</a>
for more details.</p>
...
<li>
<p><a id="" title="" target="_blank" href="https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.2206/develop-applications/querying-data-cache.html#GUID-A6A97011-A2FB-45A4-B9FC-AA0C8C49C057">Querying Data In a Cache</a></p>
